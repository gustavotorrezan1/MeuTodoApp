...
public class TodoController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,Title,Done,CreatedAt,LastUpdateData,User")] Todo todo)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Done,CreatedAt,LastUpdateData,User")] Todo todo)
    {
        if (id != todo.Id)
        {
            return NotFound();
